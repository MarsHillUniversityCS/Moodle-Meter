...
function xmldb_block_timetracker_upgrade($oldversion) {
    ...
    /* things to do to the DB if we "upgrade" from an older version and
    the DB has changed
    ...
    if ($oldversion < 2012072601) {
        ...
        // Define field deleted to be added to block_timetracker_workerinfo
        $table = new xmldb_table('block_timetracker_workerinfo');
        $field = new xmldb_field('deleted', XMLDB_TYPE_INTEGER, 
            '1', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, '0', 'maxtermearnings');
        ...
        // timetracker savepoint reached
        upgrade_block_savepoint(true, 2012072601, 'timetracker');
    }
    */
